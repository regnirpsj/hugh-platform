...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/platform/sdl/window/input.hpp                                              */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/

#if !defined(HUGH_PLATFORM_SDL_WINDOW_INPUT_HPP)

#define HUGH_PLATFORM_SDL_WINDOW_INPUT_HPP
...
#endif // #if !defined(HUGH_PLATFORM_SDL_WINDOW_INPUT_HPP)
