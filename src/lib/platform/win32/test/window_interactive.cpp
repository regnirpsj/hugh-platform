...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/platform/win32/test/window_simple.cpp                                      */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/
...
namespace {
  ...
  class window : public hugh::platform::win32::window::interactive {

  public:

    using inherited  = hugh::platform::win32::window::interactive;
...
BOOST_AUTO_TEST_CASE(test_hugh_platform_win32_window_interactive)
{
  window w("test_hugh_platform_win32_window_interactive",
