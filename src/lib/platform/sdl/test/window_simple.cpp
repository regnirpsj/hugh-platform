...
namespace {
  ...
  class window : public hugh::platform::sdl::window::simple {

  public:

    using inherited  = hugh::platform::sdl::window::simple;
...
BOOST_AUTO_TEST_CASE(test_hugh_platform_sdl_window_simple)
{
  window w("test_hugh_platform_sdl_window_simple",
