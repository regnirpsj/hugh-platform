...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/platform/sdl/test/appication.cpp                                           */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/
...
BOOST_AUTO_TEST_CASE(test_hugh_platform_sdl_application_execute)
{
  namespace hpa = hugh::platform::application;
  namespace hppa = hugh::platform::sdl::application;
