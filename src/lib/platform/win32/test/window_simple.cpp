...
namespace {
  ...
  class window : public hugh::platform::win32::window::simple {

  public:

    using inherited  = hugh::platform::win32::window::simple;
...
BOOST_AUTO_TEST_CASE(test_hugh_platform_win32_window_simple)
{
  window w("test_hugh_platform_win32_window_simple",
